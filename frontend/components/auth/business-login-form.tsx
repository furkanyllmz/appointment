  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (decoded?.role !== "Admin") {
        setError("İşletme hesabı ile giriş yapın")
        return
      }
  ...
  return (
    <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-12 bg-white">
      <div className="w-full max-w-md">
        <h1 className="text-3xl font-bold mb-2 text-gray-900">İşletme Girişi</h1>
        <p className="text-gray-600 mb-8">İşletme hesabınızda giriş yapın</p>
        ...
        <p className="mt-6 text-center text-gray-600">
          Hesabınız yok mu?{" "}
          <Link href="/business/register" className="text-black font-medium hover:underline">
            Kayıt Ol
          </Link>
        </p>
      </div>
